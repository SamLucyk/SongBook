...
<?php if ($this->session->userdata('user_data')['is_logged_in']){ $this->load->view('songbook/sidenav'); }?>
...
?>
<div class="col-xs-12 center songbook-wrap padd-65-40">
    <div class="<?php echo $theme->class; ?>  col-xs-12 padd-20-0" style="width:100%">
        <script>
